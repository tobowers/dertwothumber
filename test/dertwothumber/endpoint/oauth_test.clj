...
(deftest smoke-test
  (testing "oauth page exists"
    (let [response (handler (mock/request :get "/oauth/github"))]
      ...
      (is (= "https://github.com/login/oauth/authorize?response_type=code&client_id=test-client-id&redirect_uri=http%3A%2F%2Ffake-host%2Foauth%2Fgithub%2Fauthorize&scope=repo"
